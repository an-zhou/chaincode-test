...
/*
func (t *TestChaincode) write(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *TestChaincode) read(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
